      ...
      <div className="container-custom relative z-10 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center lg:text-left animate-fade-in">
          ...
          <p className="text-gray-600 text-lg mb-8 leading-relaxed max-w-xl">
            Vyzentech delivers innovative IT solutions designed to transform your business. From web development to digital transformation, we empower companies to achieve their goals with modern technology.
          </p>
